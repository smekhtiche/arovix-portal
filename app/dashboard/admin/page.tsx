...
// ------------------------------------------------------
// IMPORTANT:
// Partners are now loaded through the secure
// server-side API route.
//
// This avoids exposing business_shops to the
// browser and fixes the Supabase RLS error:
// "permission denied for table business_shops"
// ------------------------------------------------------
...
// Reload only after successful creation.
setTimeout(() => {
...
//
// IMPORTANT:
// Do NOT manually create an AGENT-001 style ID.
//
// The Supabase agents.id column is BIGINT.
// Supabase/database generates the numeric ID.
//
// Also:
// Do NOT insert total_partners or total_sales
// because those columns are not guaranteed to exist.
//
// ============================================================
...
// Add the newly created agent
// to the existing local list.
if (data) {
setAgents((prev) => [
data as Agent,
...prev,
...
// Return to first page so the new agent
...
// ============================================================
//
// PartnerTable performs the real server-side top-up.
//
// /api/admin/topup
// ↓
// top_up_partner_credit RPC
//
// This function ONLY updates local UI.
//
// ============================================================
