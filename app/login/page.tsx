...
*
* "agency" is also accepted for future compatibility,
* but the existing AROVIX role is "partner".
*/
...
if (!dashboardPath) {
throw new Error(
"Your account role is not configured correctly. Please contact AROVIX support."
);
}
...
if (!dashboardPath) {
throw new Error(
"Your invitation role is not configured correctly. Please contact AROVIX support."
);
}
